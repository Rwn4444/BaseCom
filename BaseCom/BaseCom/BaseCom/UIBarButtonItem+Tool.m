...
+(instancetype)RWN_BarButnWithFrame:(CGRect)frame
    ...
    return [UIBarButtonItem RWN_BarButnWithFrame:frame title:title titleColor:titleColor image:nil font:font Target:target action:action direction:RWNBarMiddle];
}
